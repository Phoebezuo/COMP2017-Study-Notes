/* The purpose of this module is for students to synchronise 
 * the counter variable among the 5 threads
 */
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
...
// this variable is shared among the 5 threads
// there are 5 different mutex guarding this, 
// however, because they are different mutex, 
// on the same resources, it does not serialise access
// how to make it serialised?
long counter = 0;
